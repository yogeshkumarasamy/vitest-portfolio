...
export function PricingCard({
  ...
  return (
    <Card
      className={cn(highlighted && 'border-blue-600 shadow-lg', className)}
    ...
    >
      <CardHeader>
        ...
        <CardDescription data-testid="pricing-description">
          {description}
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        <div>
          <div className="flex items-baseline gap-1">
            ...
            <span className="text-gray-600" data-testid="pricing-period">
              /{period}
            </span>
          </div>
        </div>
