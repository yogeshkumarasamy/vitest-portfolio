        ...
        <section className="space-y-6">
          <div className="space-y-4">
            ...
            <Lead className="max-w-3xl">
              A comprehensive overview of my technical expertise across frontend, backend, cloud technologies,
            ...
            {softSkills.map((skill) => (
              <Card key={skill}>
                <CardContent className="p-6 text-center">
                  <p className="font-medium text-gray-900 dark:text-gray-100">{skill}</p>
                </CardContent>
              </Card>
            ))}
          </div>
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600 dark:text-gray-400">Associate Level - 2023</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader>
          ...
          <Card className="bg-gradient-to-br from-blue-50/5 dark:from-blue-950/5 to-gray-50/5 dark:to-gray-950/5">
            <CardContent className="p-8 text-center space-y-4">
              ...
              <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                ...
                frameworks, attend conferences, and contribute to open-source projects to stay at the forefront
                of web development.
              </p>
            </CardContent>
          </Card>
