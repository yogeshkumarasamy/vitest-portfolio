  ...
  const experiences = [
    {
      ...
      description:
        'Leading architectural decisions for enterprise applications, focusing on microservices and microfrontend architectures. Responsible for technical strategy, system design, and mentoring senior developers.',
      technologies: [
        'React',
        'TypeScript',
        'Node.js',
    ...
    },
    {
      ...
      description:
        'Led a team of 8 frontend developers in building modern web applications using React and Module Federation. Drove technical decisions and established frontend architecture standards.',
      technologies: [
        'React',
        'TypeScript',
        'Webpack',
    ...
    },
    {
      ...
      description:
        'Developed and maintained full-stack applications using React, Node.js, and cloud technologies. Collaborated with product and design teams to deliver high-quality features.',
      technologies: [
        'React',
        'Node.js',
        'Express',
    ...
    },
    {
      ...
      description:
        'Full-stack development role working on various web applications. Gained experience in agile methodologies, version control, and modern development practices.',
      technologies: [
        'JavaScript',
        'React',
        'Node.js',
        ...
        <section className="space-y-6">
          <div className="space-y-4">
            ...
            <Lead className="max-w-3xl">
              A detailed look at my professional journey, highlighting key
              roles, responsibilities, and achievements throughout my career in
        ...
        <section className="space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              {experiences.length} positions spanning{' '}
        ...
        <section className="pt-12">
          <div className="bg-card space-y-4 rounded-lg border p-8 text-center">
            ...
            <p className="mx-auto max-w-2xl text-gray-600 dark:text-gray-400">
              Feel free to reach out if you'd like to discuss my experience in
              more detail or learn about specific projects and technical
